...
bool autocar_msgs__msg__polygon__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autocar_msgs.msg._polygon.Polygon", full_classname_dest, 33) == 0);
  }
  autocar_msgs__msg__Polygon * ros_message = _ros_message;
  {  // n
...
PyObject * autocar_msgs__msg__polygon__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autocar_msgs.msg._polygon");
