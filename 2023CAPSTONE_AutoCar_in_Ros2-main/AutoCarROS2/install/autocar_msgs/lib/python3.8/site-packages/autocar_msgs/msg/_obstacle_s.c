...
bool autocar_msgs__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autocar_msgs.msg._obstacle.Obstacle", full_classname_dest, 35) == 0);
  }
  autocar_msgs__msg__Obstacle * ros_message = _ros_message;
  {  // detected
  ...
  {  // obstacle
    ...
    rosidl_runtime_c__String__assign(&ros_message->obstacle, PyBytes_AS_STRING(encoded_field));
...
PyObject * autocar_msgs__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autocar_msgs.msg._obstacle");
  ...
  {  // obstacle
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->obstacle.data,
      strlen(ros_message->obstacle.data),
      "replace");
    if (!field) {
      return NULL;
    }
