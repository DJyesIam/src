...
#include "autocar_msgs/msg/detail/object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autocar_msgs::msg::ObjectArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autocar_msgs::msg::ObjectArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autocar_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const autocar_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autocar_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  return max_serialized_size_ObjectArray(full_bounded, 0);
}
...
{
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_ObjectArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocar_msgs, msg, ObjectArray)() {
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_ObjectArray__handle;
}
