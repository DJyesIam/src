...
#include "autocar_msgs/msg/detail/polygon_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autocar_msgs::msg::Polygon &,
...
cdr_serialize(
  const autocar_msgs::msg::PolygonArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autocar_msgs::msg::PolygonArray & ros_message)
{
  // Member: polygon_list
  {
    uint32_t cdrSize;
    ...
    ros_message.polygon_list.resize(size);
    for (size_t i = 0; i < size; i++) {
      autocar_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.polygon_list[i]);
    }
  }
  ...
  // Member: polygon_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.polygon_list[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: polygon_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autocar_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Polygon(
...
{
  auto typed_message =
    static_cast<const autocar_msgs::msg::PolygonArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autocar_msgs::msg::PolygonArray *>(
    untyped_ros_message);
...
{
  return max_serialized_size_PolygonArray(full_bounded, 0);
}
...
{
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_PolygonArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocar_msgs, msg, PolygonArray)() {
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_PolygonArray__handle;
}
