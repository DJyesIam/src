...
#include "autocar_msgs/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autocar_msgs::msg::Control & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autocar_msgs::msg::Control & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const autocar_msgs::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autocar_msgs::msg::Control *>(
    untyped_ros_message);
...
{
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocar_msgs, msg, Control)() {
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
